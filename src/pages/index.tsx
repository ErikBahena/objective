  ...
  return (
    <>
      ...
      <main className='container max-w-screen-lg mx-auto flex flex-col'>
        <Heading />
        <Link href="https://deploy-preview-391--hosted-player.netlify.app/?clientID=1000000000&eventID=2022071014" >Test referrer</Link>
        <hr />

        <h3>I frame test</h3>
        
        <iframe id="invintus-player-frame" src="https://deploy-preview-391--hosted-player.netlify.app/clientID=1000000000&eventID=2022071014" width="100%" height="720px" frameBorder="0" allowFullScreen></iframe>
